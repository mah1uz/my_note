...
/** Source citation without numeric ids: linked title, plain title fallback. */
function SourceLink({ id, results }) {
  ...
  return target
    ? <Link className="source" to={target}>{label}</Link>
